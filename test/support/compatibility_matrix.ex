defmodule CodexPooler.CompatibilityMatrix do
  ...
  @features [
    ...
    %{
      ...
      chat_reasoning_alias_contract: "nonempty Chat messages accept string reasoning as a bounded reasoning_effort alias, normalize equivalent dual fields and reject conflicts, apply ordinary API-key effort policy, and report reasoning for alias validation and policy errors; object reasoning and other Responses-only fields remain rejected with nonempty messages, while absent or empty messages retain the Responses input fallback",
