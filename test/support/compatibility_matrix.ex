defmodule CodexPooler.CompatibilityMatrix do
  ...
  @features [
    ...
    %{
      ...
      contract:
        "Images accepts gpt-image-2.5-flare and gpt-image-2.5-sunburst alongside legacy identifiers, sends basic generation and edits to native Codex Images with the requested image model, retains hosted Responses for masks, accepts GPT Image 2.5 dated snapshots, xhigh/max quality and bounded custom dimensions without promising provider adherence, and restricts configurable input_fidelity to gpt-image-1/1.5; " <>
