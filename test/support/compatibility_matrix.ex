  ...
  @fixtures %{
    ...
    duplicate_turn_fence: %{
      ...
      refused: [
        ...
        "one_turn_id_reused_across_a_user_message_after_a_websocket_opener_over_https_or_another_socket",
