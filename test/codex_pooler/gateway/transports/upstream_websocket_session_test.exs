defmodule CodexPooler.Gateway.Transports.Websocket.UpstreamWebsocketSessionTest do
  ...
  test "native websocket preserves a structural child text delta through canonical projection" do
    child_delta =
    ...
    assert_receive {:native_child_delta_frame, projected_child_delta}
    assert Jason.decode!(projected_child_delta) == Jason.decode!(child_delta)
