...
![Codex Pooler Cline integration](/codex-pooler-cline.png)

## Before you start

- Install [Cline CLI](https://docs.cline.bot/getting-started/installing-cline) using the official instructions for your operating system.
...
```json title="mcp.json" frame="code"
{
  "mcpServers": {
    "codex_pooler": {
