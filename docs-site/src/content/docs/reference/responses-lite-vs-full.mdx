...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Preserved in message content and tool outputs, on native routes and <code>/v1/responses</code> alike. <code>/v1/responses</code> refuses a value other than <code>low</code>, <code>high</code>, <code>auto</code> or <code>original</code> in either mode with <code>400 invalid_value</code> and the field path as <code>param</code>, before anything is sent upstream</td>
