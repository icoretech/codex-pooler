...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Partial</td>
      <td>Partial</td>
      <td>Narrow Responses websocket compatibility only. It is not OpenAI Realtime SDK support. It uses the same downstream idle and frame guardrails as backend Codex websockets. Malformed JSON and JSON non-object provider frames are dropped without consuming a public sequence number or creating a local terminal, including on accepted owner-forwarded turns.</td>
    </tr>
    <tr>
