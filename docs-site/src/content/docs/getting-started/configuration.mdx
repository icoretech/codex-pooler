...
During a mixed-release transition, owners started by the previous release retain the legacy five-minute behavior. Owners started or recovered by the current release use the 30-minute default.
