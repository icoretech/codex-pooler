...
head:
  - tag: script
    ...
    content: |
      {"@context":"https://schema.org","@type":"TechArticle","headline":"AI Coding Agent Gateway","description":"Codex Pooler gives trusted AI coding agents stable Pool API keys and one public gemma3 identity across Ollama, OpenAI, Anthropic Messages, and Codex routes.","url":"https://docs.codex-pooler.com/discovery/ai-coding-agent-gateway/","about":["AI coding agent gateway","Codex Pooler","gemma3 facade","Pool API keys"]}
---

Codex Pooler can act as a self-hosted gateway for trusted AI coding agents. Operators connect authorized upstream Codex accounts to Pools, issue stable Pool API keys, and expose one public `gemma3` identity through supported Ollama, Anthropic Messages, OpenAI-compatible, or Codex routes.
...
<table>
  ...
  <tbody>
    <tr>
      <td>Ollama agents and SDKs</td>
      <td><code>/api</code></td>
      <td>Pool API key</td>
      <td><a href="/clients/ollama/">Ollama clients</a></td>
    </tr>
    <tr>
      <td>Claude Code and Anthropic SDKs</td>
      <td><code>/v1/messages</code></td>
      <td>Pool API key</td>
      <td><a href="/clients/claude-code/">Claude Code</a></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>OpenAI SDK-compatible agents</td>
      <td><code>/v1</code></td>
      <td>Pool API key</td>
      <td><a href="/clients/openai-compatible/">OpenAI-compatible SDKs</a></td>
    </tr>
    <tr>
      <td>Aider, Continue, Cline, Goose, Kilo, OpenCode, OpenClaw, OpenHands, OMP, Pi, Hermes, Trae, and Windmill</td>
...
6. Choose the protocol-specific base URL and configure every client model alias as `gemma3`.
