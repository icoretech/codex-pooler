defmodule CodexPooler.Gateway.Payloads.RequestOptions.Continuity do
  ...
  @type t :: %__MODULE__{
          ...
          resolved_turn_state_assignment_id: Ecto.UUID.t() | nil,
          resolved_turn_state_session_id: Ecto.UUID.t() | nil,
  ...
  def build(opts) do
    ...
    %__MODULE__{
      ...
      resolved_turn_state_assignment_id: Map.get(opts, :resolved_turn_state_assignment_id),
      resolved_turn_state_session_id: Map.get(opts, :resolved_turn_state_session_id),
